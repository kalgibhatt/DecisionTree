...
import org.intelligentjava.machinelearning.decisiontree.label.StringLabel;
...
//		List<String> predictions = Lists.newArrayList();
	...
	private static List<Feature> getFeatures() {
		...
		Feature sourceBytesLarge = newFeature("source_bytes", moreThanD(2.0), "more than 5.0");
		...
		Feature lessHotIndicators = newFeature("hot", lessThanD(10.0), "less than 10.0");
		Feature mediumHotIndicators = newFeature("hot", betweenD(10.0, 20.0), "between 10.0 and 20.0");
		Feature moreHotIndicators = newFeature("hot", moreThanD(20.0), "more than 20.0");
		...
		Feature lessCompromised = newFeature("compromised", lessThanD(200.0), "less than 200.0");
		Feature mediumCompromised = newFeature("compromised", betweenD(200.0, 600.0), "between 200.0 and 600.0");
		Feature moreCompromised = newFeature("compromised", moreThanD(600.0), "more than 600.0");
		...
		Feature lessConnections = newFeature("connection_count", lessThanD(150.0), "less than 150.0");
		Feature mediumConnections = newFeature("connection_count", betweenD(150.0, 350.0), "between 150.0 and 350.0");
		Feature moreConnections = newFeature("connection_count", moreThanD(350.0), "more than 350.0");
		...
		Feature lessSErrorRate = newFeature("serror_rate", lessThanD(0.3), "less than 0.3");
		Feature mediumSErrorRate = newFeature("serror_rate", betweenD(0.3, 0.6), "between 0.3 and 0.6");
		Feature moreSErrorRate = newFeature("serror_rate", moreThanD(0.6), "more than 0.6");
		...
		return Arrays.asList(shortDuration, mediumDuration, longDuration, isICMP, isTCP, isUDP, isServiceAuth,
				isServiceBGP, isServiceCourier, isServiceCsnet_ns, isServiceCTF, isServiceDaytime, isServiceDiscard,
				isServiceDomain, isServiceDomain_u, isServiceEcho, isServiceEco_i, isServiceEcr_i, isServiceEfs,
				isServiceExec, isServiceFinger, isServiceFTP, isServiceFTP_data, isServiceGopher, isServiceHostnames,
				isServiceHTTP, isServiceHTTP_443, isServiceIMAP4, isServiceIRC, isServiceISO_tsap, isServiceKLogin,
				isServiceKShell, isServiceLDAP, isServiceLink, isServiceLogin, isServiceMTP, isServiceName,
				isServiceNetbios_dgm, isServiceNetbios_ns, isServiceNetbios_ssn, isServiceNetstat, isServiceNnsp,
				isServiceNntp, isServiceNtp_u, isServiceOther, isServicePm_dump, isServicePop_2, isServicePop_3,
				isServicePrinter, isServicePrivate, isServiceRed_i, isServiceRemote_job, isServiceRJE, isServiceShell,
				...
				moreFailedLoginAttempt, isLoggedIn, notLoggedIn, lessCompromised, mediumCompromised, moreCompromised,
				isRootShell, notRootShell, noSuAttempts, oneSuAttempt, moreSuAttempts, lessRootAccess, mediumRootAccess,
				moreRootAccess, lessFileCreations, mediumFileCreations, moreFileCreations, noShellPrompt,
				oneShellPrompt, moreShellPrompts, noAccessFiles, oneAccessFiles, twoAccessFiles, threeAccessFiles,
				moreAccessFiles, noOutboundCmd, moreOutboundCmd, noHotLogins, moreHotLogins, isGuestLogin,
				notGuestLogin, lessConnections, mediumConnections, moreConnections, lessServices, mediumServices,
				moreServices, lessSErrorRate, mediumSErrorRate, moreSErrorRate, lessServSErrorRate,
				mediumServSErrorRate, moreServSErrorRate, lessRErrorRate, mediumRErrorRate, moreRErrorRate,
				lessServRErrorRate, mediumServRErrorRate, moreServRErrorRate, lessSameServiceRate,
				mediumSameServiceRate, moreSameServiceRate, lessDiffServiceRate, mediumDiffServiceRate,
				moreDiffServiceRate, lessServDiffHostRate, mediumServDiffHostRate, moreServDiffHostRate,
				lessDestinationHosts, mediumDestinationHosts, moreDestinationHosts, lessDestinationHostServCount,
				mediumDestinationHostServCount, moreDestinationHostServCount, lessDestinationHostSameServiceRate,
				mediumDestinationHostSameServiceRate, moreDestinationHostSameServiceRate,
				lessDestinationHostDiffServiceRate, mediumDestinationHostDiffServiceRate,
				moreDestinationHostDiffServiceRate, lessDestinationHostSameServicePortRate,
				mediumDestinationHostSameServicePortRate, moreDestinationHostSameServicePortRate,
				lessDestinationHostDiffServicePortRate, mediumDestinationHostDiffServicePortRate,
				moreDestinationHostDiffServicePortRate, lessDestinationHostSErrorRate, mediumDestinationHostSErrorRate,
				moreDestinationHostSErrorRate, lessDestinationHostServiceSErrorRate,
