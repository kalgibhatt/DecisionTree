...
public class Main {
	...
	private static List<Feature> getFeatures() {
		...
		// Feature moreUrgentPackets = newFeature("urgent", moreThan(1), "more
		// than 1");

		// Feature lessHotIndicators = newFeature("hot", lessThanD(1.0), "less
		// than 10.0");
		// Feature mediumHotIndicators = newFeature("hot", betweenD(1.0, 5.0),
		// "between 10.0 and 20.0");
		// Feature moreHotIndicators = newFeature("hot", moreThanD(5.0), "more
		// than 20.0");
		//
		...
		// Feature lessRootAccess = newFeature("root", lessThanD(200.0), "less
		// than 200.0");
		// Feature mediumRootAccess = newFeature("root", betweenD(200.0, 700.0),
		// "between 200.0 and 700.0");
		// Feature moreRootAccess = newFeature("root", moreThanD(700.0), "more
		// than 700.0");
		...
		// Feature moreShellPrompts = newFeature("shells", moreThan(1), "more
		// than 1");
